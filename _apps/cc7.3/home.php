...
class home extends VP\Controller\hooks {
    ...
    function __construct() {
        ...
        function home_js($arg) {
            echo '<script type="text/javascript" src="https://cdn.rawgit.com/krishnaTORQUE/ImageSlider/master/slidelibrary.js"></script>' . "\n";
        ...
        require_once $this->PATH('ACTIVE_APP') . 'includes/home_slider.php';
