...
<div class="contents home_con">
    ...
    <p>
        Club Coding allows you to have a great web presence through your website by providing you with great web development 
    ...
    To make your site safe, Club Coding can test, find or consult about security issue for your web app or site.
    ...
    <a class="btn btn_cbu btn_curve cc_big_btn" href="<?php echo $this->URL('APP'); ?>contact">Contact US</a> 
